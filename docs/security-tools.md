...
**简介：** CodaMOSA是CODAMOSA: Escaping Coverage Plateaus in Test Generation with Pre-trained Large Language Models的论文代码，实现了一款结合了OpenAI API的LLM-Fuzzer，旨在缓解传统fuzz中陷入覆盖率停滞不前的问题。
